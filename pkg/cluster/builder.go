...
func (b FileSpecBuilder) Build(clusterConfigURL string) (*Spec, error) {
	...
	eksaRelease := b.buildEKSARelease(release, bundlesManifest)
...
func (b FileSpecBuilder) buildEKSARelease(release *releasev1.EksARelease, bundle *releasev1.Bundles) *releasev1.EKSARelease {
